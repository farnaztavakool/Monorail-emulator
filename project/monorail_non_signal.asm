...
.equ			FIFTY_DUTY_CYCLE_VALUE = 0x80							; constant that indicate the value of OCRnx to achive 50% duty cycle
.equ			LED_STOPPING_PATTERN = 0b00000011						; constant that contains the which pattern should blink when the train is stopping
.equ			MONORAIL_STOP = 11								; constant to indicates monorail is stopping
.equ			MONORAIL_TRAVEL = 10								; constant to indicates monorail is travelling
...
input_reading_finish:									; input reading finish at this point
	...
	rcall			delay_three_half_seconds				; allow timer0 to stabilize
	cli
